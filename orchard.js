...
console.log("It will take about " + days + " days to finish the acres that remain")
...
// all profits add to 547,170 - originally I was going to add just the number of the total profits, but I know it's better to implenent the variable rather than the hard number
